      ...
      <Section id="about" title="About Me" className="text-center">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 text-left md:grid-cols-2">
          <div className="space-y-5 max-w-prose md:max-w-none">
            ...
            <p>
              I'm a Computer Science graduate who loves building systems that blend clean engineering with thoughtful, user-centered design. From full-stack development to data engineering and cloud deployment, I've worked across the stack to create reliable, scalable, and intuitive software. I enjoy transforming complex problems into simple, elegant solutions - whether that’s crafting APIs, optimizing databases, or bringing interfaces to life with modern frontend frameworks.
            </p>
            <p>
              My experience spans Spring Boot, Node.js, React, PostgreSQL, Docker, AWS, and AI-driven workflows, and I'm continuously exploring new ways to build better, faster, and smarter. I'm looking for opportunities where I can contribute to impactful products, grow within a collaborative engineering culture, and deepen my expertise in platform-oriented full-stack development.
            </p>
          </div>
